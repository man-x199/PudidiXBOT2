...
client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `𝗛𝗮𝗹𝗹𝗼 @${num.split('@')[0]}\𝘀𝗲𝗹𝗮𝗺𝗮𝘁 𝗱𝗮𝘁𝗮𝗻𝗴 𝗱𝗶 𝗴𝗿𝗼𝘂𝗽 *${mdata.subject}* 𝘆𝗮𝗻𝗴 𝗯𝗲𝘁𝗮𝗵 𝘆𝗮𝗵 𝗱𝗶𝘀𝗶𝗻𝗶🖤`
				...
				teks = `𝗬𝗼𝘀𝗵 𝗕𝗲𝗯𝗮𝗻 𝗶𝗹𝗮𝗻𝗴 𝗦𝗮𝘁𝘂🐦 @${num.split('@')[0]} 𝗴𝗮 𝘂𝘀𝗮𝗵 𝗯𝗮𝗹𝗶𝗸 𝗸𝗲𝘀𝗶𝗻𝗶 𝗹𝗮𝗴𝗶 𝘆𝗮𝗵 *<3*`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			mess = {
				wait: '❬❗❭ 𝗪𝗔𝗜𝗧, 𝗣𝗿𝗼𝗰𝗲𝘀𝘀𝗶𝗻𝗴...',
				success: '️❬ ✔ ❭ 𝘀𝘂𝗰𝗰𝗲𝘀𝘀 *!*🖤',
				error: {
					stick: '𝗬𝗲𝗮𝗵 𝗴𝗮𝗴𝗮𝗹 ;(, 𝘂𝗹𝗮𝗻𝗴𝗶 𝗹𝗮𝗴𝗶 𝘆𝗮𝗵. ^_^',
					Iv: '𝗠𝗮𝗮𝗳 𝗹𝗶𝗻𝗸 𝘁𝗶𝗱𝗮𝗸 𝘃𝗮𝗹𝗶𝗱 *!*'
				},
				only: {
					group: '❬❗❭ 𝗚𝗥𝗢𝗨𝗣 𝗢𝗡𝗟𝗬 𝗚𝗔𝗡',
					ownerG: '❬❗❭ 𝗢𝗪𝗡𝗘𝗥 𝗢𝗡𝗟𝗬 𝗚𝗔𝗡',
					ownerB: '❬❗❭  𝗢𝗪𝗡𝗘𝗥 𝗢𝗡𝗟𝗬 𝗚𝗔𝗡',
					admin: '❬❗❭ 𝗔𝗗𝗠𝗜𝗡 𝗢𝗡𝗟𝗬 𝗚𝗔𝗡',
					Badmin: '❬❗❭ 𝗕𝗢𝗧 𝗛𝗔𝗥𝗨𝗦 𝗝𝗔𝗗𝗜 𝗔𝗗𝗠𝗜𝗡 𝗚𝗔𝗡'
				}
			}
			...
			switch(command) {
				...
				case 'donate':
					...
					case 'iri?':
            case 'iri':
                client.sendMessage(from, 'Pudidi' + 'iri.mp3', {quoted: mek, ptt:true})
                break
                
            case 'abgjago':
            case 'abangjago':
                client.sendMessage(from, 'Pudidi' + 'abangjago'+'mp3', {quoted: mek, ptt:true})
                break
            case 'tarekses':
            case 'tariksis':
            case 'tareksis':
            case 'tareeksis':
            case 'tareekses':
                client.sendMessage(from, './Pudidi'+'/tarekses.mp3', {quoted: mek, ptt:true})
                break
            case 'welotka':
            case 'welutka':
            case 'kangcopet':
                client.sendMessage(dari, './Pudidi'+'welot'+'mp3',{quoted: mek, ptt:true})
                break
				...
				case 'ocr': 
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						reply('_*kirim foto dengan caption*_ ${prefix}ocr')
					}
					break
				case 'stiker': 
				case 'sticker':
					...
					if ((isMedia && !mek.message.videoMessage || isQuotedImage) && args.length == 0) {
						...
						await ffmpeg(`./${media}`)
							...
							.on('error', function (err) {
								...
								reply(`𝗬𝗲𝗮𝗵 𝗴𝗮𝗴𝗮𝗹 ;(, 𝘂𝗹𝗮𝗻𝗴𝗶 𝗹𝗮𝗴𝗶 𝘆𝗮𝗵. ^_^`)
							})
							.on('end', function () {
								console.log('Finish')
								buff = fs.readFileSync(ran)
						...
						await removeBackgroundFromImageFile({path: media, apiKey: keyrmbg.result, size: 'auto', type: 'auto', ranp}).then(res => {
							...
							fs.writeFileSync(ranp, buffer, (err) => {
								if (err) return reply('𝗬𝗲𝗮𝗵 𝗴𝗮𝗴𝗮𝗹 ;(, 𝘂𝗹𝗮𝗻𝗴𝗶 𝗹𝗮𝗴𝗶 𝘆𝗮𝗵. ^_^')
							})
						...
						reply(`_*kirim gambar dengan caption*_ ${prefix}sticker _*atau reply/tag gambar*_`)
					}
					break
				case 'getses':
            ...
            break	
				case 'gtts':	
				case 'tts':
					if (args.length < 1) return client.sendMessage(from, '𝗱𝗶𝗽𝗲??𝗹𝘂𝗸𝗮𝗻 𝗸𝗼𝗱𝗲 𝗯𝗮𝗵𝗮𝘀𝗮 *!*', text, {quoted: mek})
					const gtts = require('./lib/gtts')(args[0])
					if (args.length < 2) return client.sendMessage(from, '𝗧𝘂𝗹𝗶𝘀𝗸𝗮𝗻 𝘁𝗲𝗸𝘀 𝘆𝗮𝗻𝗴 𝗺𝗮𝘂 𝗱𝗶𝗷𝗮𝗱𝗶𝗸𝗮𝗻 𝘀𝘂𝗮𝗿𝗮 *!*', text, {quoted: mek})
					dtt = body.slice(9)
					ranm = getRandom('.mp3')
					rano = getRandom('.ogg')
					dtt.length > 300
					? reply('𝗠𝗮𝗮𝗳, 𝗧𝗲𝗸𝘀 𝗧𝗲𝗿𝗹𝗮𝗹𝘂 𝗣𝗮𝗻𝗷𝗮𝗻𝗴 *!*')
			...
			case 'loli': 
				...
				case 'nsfwloli': 
				    try {
						if (!isNsfw) return reply('𝗠𝗮𝗮𝗳 𝗳𝗶𝘁𝘂𝗿 𝗶𝗻𝗶 𝗯𝗲𝗹𝘂𝗺 𝗱𝗶 𝗮𝗸𝘁𝗶𝗳𝗸𝗮𝗻.')
						res = await fetchJson(`https://api.lolis.life/random?nsfw=true`, {method: 'get'})
						buffer = await getBuffer(res.url)
						client.sendMessage(from, buffer, image, {quoted: mek, caption: '𝗦𝘂𝗸𝘀𝗲𝘀 *!*, 𝗶𝗻𝗶 𝗴𝗮𝗻.'})
					} catch (e) {
						console.log(`Error :`, color(e,'red'))
						reply('𝗘𝗥𝗥𝗢𝗥 𝗚𝗔𝗡 *!*')
					}
					break
				case 'hilih': 
					if (args.length < 1) return reply('𝗠𝗮𝘀𝘂𝗸𝗮𝗻 𝗧𝗲𝗸𝘀𝗻𝘆𝗮 𝗚𝗮𝗻 *!*')
					anu = await fetchJson(`https://mhankbarbars.herokuapp.com/api/hilih?teks=${body.slice(7)}`, {method: 'get'})
					reply(anu.result)
					break
				case 'yt': 
					if (args.length < 1) return reply('𝗠𝗮𝘀𝘂𝗸𝗮𝗻 𝗨𝗥𝗟 𝗻𝘆𝗮 𝗚𝗮𝗻 *!*')
					...
					break
				case 'ytsearch': 
					if (args.length < 1) return reply('𝗦𝗶𝗹𝗮𝗵𝗸𝗮𝗻 𝗞𝗲𝘁𝗶𝗸𝗮𝗻 𝗬𝗮𝗻𝗴 𝗠𝗮𝘂 𝗗𝗶𝗰𝗮𝗿𝗶.')
				...
				case 'tiktokstalk':
					try {
						if (args.length < 1) return client.sendMessage(from, '𝗠𝗮𝘀𝘂𝗸𝗮𝗻 𝗨𝘀𝗲𝗿𝗻𝗮𝗺𝗲 𝗡𝘆𝗮 𝗚𝗮𝗻.', text, {quoted: mek})
				...
				case 'nulis': 
				case 'tulis':
					if (args.length < 1) return reply('𝗞𝗲𝘁𝗶𝗸𝗮𝗻 𝗬𝗮𝗻𝗴 𝗠𝗮𝘂 𝗗𝗶𝘁𝘂𝗹𝗶𝘀 *!*')
					teks = body.slice(7)
					reply(mess.wait)
				...
				case 'url2img': 
					...
					if (args.length < 1) return reply('𝗦𝗶𝗹𝗮𝗵𝗸𝗮𝗻 𝗣𝗶𝗹𝗶𝗵 */* 𝗠𝗮𝘀𝘂𝗸𝗮𝗻 𝗧𝗶𝗽𝗲𝗻𝘆𝗮.')
					if (!tipelist.includes(args[0])) return reply('𝗧𝗶𝗽𝗲 𝗱𝗲𝘀𝗸𝘁𝗼𝗽|𝘁𝗮𝗯𝗹𝗲𝘁|𝗺𝗼𝗯𝗶𝗹𝗲')
					if (args.length < 2) return reply('𝗠𝗮𝘀𝘂𝗸𝗮𝗻 𝗨𝗥𝗟 𝗻𝘆𝗮 𝗚𝗮𝗻 *!*')
...
break
				...
				case 'tagall':
					...
					break
				case 'clearall':
					if (!isOwner) return reply('𝙇𝙪 𝙎𝙞𝙖𝙥𝙖 𝙏𝙤𝙙 *?*')
       ...
       client.sendMessage(from, '𝗧𝘂𝗵 𝗱𝗮𝗵 𝗮𝗸𝘂 𝗸𝗮𝘀𝗶𝗵 𝗻𝗼𝗺𝗲𝗿 𝗖𝗢 🔹𝗣𝗨𝗗𝗜𝗗𝗜𝗫𝗕𝗢𝗧🔹,𝗝𝗔𝗡𝗚𝗔𝗡 𝗟𝗨𝗣𝗔 𝗗𝗜 𝗦𝗔𝗩𝗘 *>~<*',MessageType.text, { quoted: mek} )
           break    
           case 'demote':
					if (!isGroup) return reply(mess.only.group)
					if (!isGroupAdmins) return reply(mess.only.admin)
				...
				case 'toimg':
					...
					exec(`ffmpeg -i ${media} ${ran}`, (err) => {
						...
						client.sendMessage(from, buffer, image, {quoted: mek, caption: '𝗕𝗲𝗿𝗵𝗮𝘀𝗶𝗹 *!*, 𝗜𝗻𝗶 𝗚𝗮𝗻.'})
						fs.unlinkSync(ran)
					})
					break
				...
				case 'simih':
					...
					if (Number(args[0]) === 1) {
						if (isSimi) return reply('𝗦𝘂𝗱𝗮𝗵 𝗗𝗶𝗮𝗸𝘁𝗶𝗳𝗸𝗮𝗻 𝗚𝗮𝗻 *!*')
						samih.push(from)
				...
				case 'nsfw':
					...
					if (args.length < 1) return reply('𝗧𝗼𝗱 :𝘃')
					if (Number(args[0]) === 1) {
						if (isNsfw) return reply('𝗦𝘂𝗱𝗮𝗵 𝗗𝗶𝗮𝗸𝘁𝗶𝗳𝗸𝗮𝗻 𝗚𝗮𝗻 *!*')
						nsfw.push(from)
				...
				case 'welcome':
					...
					if (args.length < 1) return reply('𝗧𝗼𝗱 :𝘃')
					if (Number(args[0]) === 1) {
						if (isWelkom) return reply('𝗦𝘂𝗱𝗮𝗵 𝗗𝗶𝗮𝗸𝘁𝗶𝗳𝗸𝗮𝗻 𝗚𝗮𝗻 *!*')
						welkom.push(from)
